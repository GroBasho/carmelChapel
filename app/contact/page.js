      ...
      <div className='p-0 m-0 container flex sm:flex-row flex-col-reverse w-full h-full justify-center items-center'>
        ...
        <div className='sm:w-[55%]  w-full h-full text-center self-center p-6 mb-4'>
          <form className='flex flex-col justify-center items-center text-left mx-6'>
            <label
              htmlFor='first-name'
              className='text-sm font-medium leading-6 text-[#80011F] text-left w-full'
            >
              Name
            </label>
            <input
              ...
              className='w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-[#80011F] placeholder:text-gray-400 focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 bg-[#FFF5E1] pl-2'
            />
            <label
              htmlFor='email'
              className='text-sm font-medium leading-6 text-[#80011F] text-left w-full'
            ...
            <label
              htmlFor='about'
              className='block text-sm font-medium leading-6 text-[#80011F] text-left w-full'
            >
              About
            </label>
            <textarea
              ...
              name='about'
              rows='3'
              className='w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-[#80011F] placeholder:text-gray-400 focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 bg-[#FFF5E1]'
            ></textarea>
